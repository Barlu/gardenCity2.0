 ...
 */
class Recipe extends \Entity\Recipe implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'products', 'id', 'name', 'description', 'file', 'image', 'dateAdded');
        }
