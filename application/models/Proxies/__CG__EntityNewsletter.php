 ...
 */
class Newsletter extends \Entity\Newsletter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'link', 'id', 'name', 'description', 'file', 'image', 'dateAdded');
        }
     ...
     * {@inheritDoc}
     */
    public function setImage(\Entity\Image $image)
    {
