...
class Image extends \Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'location', 'title', 'gallery');
        }
     ...
     * {@inheritDoc}
     */
    public function getLocation($substr = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLocation', array($substr));

        return parent::getLocation($substr);
    }
